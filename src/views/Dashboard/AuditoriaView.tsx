...
import { auditoriaApi, type AuditoriaAcceso } from '../../services/api';
...
export function AuditoriaView() {
    ...
    const cargarAuditoria = async () => {
        try {
            ...
            const data = await auditoriaApi.listarAccesosAsync({
                username,
                evento,
                exitoso,
                fechaInicio,
        ...
        <div className="space-y-4">
            <div>
                ...
                <p className="text-sm text-gray-500">
                    Consulta de eventos de login, logout, cambio de sede y refresh de sesión.
                </p>
            </div>
            <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                <div className="grid grid-cols-1 gap-3 md:grid-cols-5">
                    ...
                    >
                        ...
                        <option value="CAMBIO_PLANTA">CAMBIO_PLANTA</option>
                        <option value="REFRESH_SESION">REFRESH_SESION</option>
                    </select>
