  ...
  const inspeccionesMock = [
    {
      placa: 'AHQ305',
      dni: '09043065',
      nombre: 'ALBINO LUCIO POCOMUCHA MEJIA',
      fecha: '08-jun-2026 12:56:58',
      concepto: 'PARTICULAR LIVIANOS',
      linea: 'L1_MIXTA',
      estado: 'PROFUNDIMETRO'
    },
    {
      placa: 'CSP208',
      dni: '20604368406',
      nombre: 'BFK MOTORS S.A.C.',
      fecha: '08-jun-2026 13:06:30',
      concepto: 'TAXI',
      linea: 'L1_MIXTA',
      estado: 'ALINEACION'
    }
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg shadow border border-slate-200 p-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between pb-4 border-b border-slate-100 gap-4">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              La información se debe filtrar por la sede activa.
            </p>
          </div>
          ...
          <table className="w-full text-left border-collapse text-xs">
            <thead>
              <tr className="bg-[#26b49a] text-white font-semibold">
                ...
                <th className="p-3 border-r border-teal-600">Línea</th>
                <th className="p-3 border-r border-teal-600">
                  Estado Actual
                </th>
            ...
            <tbody className="divide-y divide-slate-200 text-slate-700">
              {inspeccionesMock.map((ins, idx) => (
                ...
                >
                  ...
                  <td className="p-3 font-mono text-center bg-slate-50/30">
                    {ins.linea}
                  </td>
        ...
        <div className="mt-3 text-[11px] text-slate-400">
          Filtro técnico esperado para API:
          <span className="ml-1 font-mono text-slate-600">
            plantaKey={plantaSeleccionada || 'N/A'}
          </span>
        </div>
      </div>
    </div>
