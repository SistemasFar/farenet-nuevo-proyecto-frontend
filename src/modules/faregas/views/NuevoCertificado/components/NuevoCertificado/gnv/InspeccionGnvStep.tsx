...
export function InspeccionGnvStep({ formData, setFormData, onNext }: InspeccionGnvStepProps) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
      <h3 className="text-sm font-black text-[#052a79] capitalize mb-4">Inspección GNV</h3>
      ...
      <div className="bg-slate-50 border border-slate-100 p-6 rounded-xl mb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="col-span-full border-t border-slate-200 pt-4 mt-2">
            <h4 className="text-xs font-bold text-slate-700 capitalize mb-3">Datos del Cilindro</h4>
          </div>
          ...
          <div className="col-span-full border-t border-slate-200 pt-4 mt-2">
            <h4 className="text-xs font-bold text-slate-700 capitalize mb-3">Datos del Kit</h4>
          </div>
          ...
          <div className="col-span-full border-t border-slate-200 pt-4 mt-2">
            <h4 className="text-xs font-bold text-slate-700 capitalize mb-3">Verificaciones Físicas</h4>
