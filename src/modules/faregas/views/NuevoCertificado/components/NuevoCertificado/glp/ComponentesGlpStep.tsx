...
export function ComponentesGlpStep({ formData, setFormData, onNext }: ComponentesGlpStepProps) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
      <h3 className="text-sm font-black text-[#052a79] capitalize mb-4">Componentes Instalados (GLP)</h3>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div className="bg-slate-50 border border-slate-100 p-4 rounded-xl">
          <h4 className="text-xs font-bold text-slate-700 capitalize mb-3">Cilindro</h4>
        ...
        <div className="bg-slate-50 border border-slate-100 p-4 rounded-xl">
          <h4 className="text-xs font-bold text-slate-700 capitalize mb-3">Regulador / Evaporador</h4>
          <div className="space-y-4">
